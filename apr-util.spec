...
# Drop private modules from provides
%{?filter_setup:
%filter_provides_in %{_libdir}/apr-util-%{apuver}/
%filter_from_requires /apr_dbd_.*\.so/d
%filter_from_requires /apr_crypto_.*\.so/d
%filter_from_requires /apr_ldap.*\.so/d
%filter_setup
}
...
Patch100: apr-util-1.5.2-httpd24-soname.patch
...
%changelog
* Mon Feb 02 2015 Jan Kaluza <jkaluza@redhat.com> - 1.5.4-1
- update to version 1.5.4

* Wed Jan 28 2015 Jan Kaluza <jkaluza@redhat.com> - 1.5.2-8
- rebuild for rhscl-2.0

* Thu Jan 09 2014 Jan Kaluza <jorton@redhat.com> - 1.5.2-7
- filter out private libraries from requires (#1042877)

* Thu Jan 09 2014 Jan Kaluza <jorton@redhat.com> - 1.5.2-6
- filter out private libraries from provides (#1042877)
